            ...
            <div class="flex justify-center">
                <div class="relative w-[85%] py-10 h-[400px] overflow-hidden">
                    <div id="carousel" class="flex w-full transition-transform duration-300 gap-3">
                        <div class="carousel-item h-[350px] bg-gray-600 rounded-2xl relative ml-2"
                        ...
                        <div class="carousel-item h-[350px] rounded-lg bg-gray-300 p-1"
                    ...
                    <div class="w-[84%]  bg-gray-100 rounded-lg">
                        ...
                        <div class="bg-white w-full rounded-md shadow-md h-auto py-3 px-3 my-5">
                            ...
                            <div class="grid grid-cols-3 w-full px-5 px-5 my-3">
                                <button class="flex flex-row justify-center items-center w-full space-x-3"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 24 24"
                                        fill="none" stroke="#838383" stroke-width="2" stroke-linecap="square"
                                        stroke-linejoin="round">
                                        <path
                                            d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3">
                                        </path>
